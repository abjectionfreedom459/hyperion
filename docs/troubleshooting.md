...
**Symptom:**
```
Error! Bad return status for module build on kernel: 6.19.6-Hyperion-0.2.0
```
...
```bash
readlink /lib/modules/6.19.6-Hyperion-0.2.0/build
# Must point to /usr/src/linux-headers-6.19.6-Hyperion-0.2.0

# Fix if wrong:
sudo ln -sfn /usr/src/linux-headers-6.19.6-Hyperion-0.2.0 \
    /lib/modules/6.19.6-Hyperion-0.2.0/build
```

**Step 3: Try building DKMS module manually**
```bash
sudo dkms build -m nvidia -v 550.54.14 -k 6.19.6-Hyperion-0.2.0 --verbose
```
...
dmesg: foo: version magic '6.19.6 ...' should be '6.19.6-Hyperion-0.2.0 ...'
```
