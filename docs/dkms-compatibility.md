...
# → /lib/modules/6.19.6-Hyperion-0.2.0/build -> /usr/src/linux-headers-6.19.6-Hyperion-0.2.0
```
...
# nvidia/550.54.14, 6.19.6-Hyperion-0.2.0, x86_64: installed ✓
...
```
/usr/src/linux-headers-6.19.6-Hyperion-0.2.0/Module.symvers
```
